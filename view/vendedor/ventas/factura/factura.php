						...
						<table class="datos_cliente">
							...
							<tr>
								<td><label>Nombre:</label>
									<p><?php echo $factura['nombre'] . ' ' . $factura['apellido']; ?></p>
								</td>
								<td><label>E-Mail:</label>
									<p><?php echo $factura['email']; ?></p>
								</td>
							</tr>
						</table>
					</div>
			...
			<tbody id="detalle_productos">
				...
				?>
						<tr>
							...
							<td class="textright"><?php echo $row['precio_final']; ?></td>
						</tr>
				<?php
						$precio_total = $row['precio_final'];
